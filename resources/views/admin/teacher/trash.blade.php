...
<div class="content container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <a class="btn btn-sm btn-primary" href="{{route('staff.create')}}">Add New Teacher</a>
            <br><br>
                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<td>
                                    <a class="btn btn-info" href="{{route('teacher.trash',$data->id) }}">Restore </a>
                                   
                                  <form class="d-inline" action="{{ route('teacher.destroy',$data->id)}}" method="POST">
									@csrf
									@method('DELETE')
